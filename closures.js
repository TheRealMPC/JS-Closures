...
function findPotentialFriends(existingFriends) {
  return function(friends){
    if (existingFriends.includes(friends)){
      return false
    } else {
      return true;
    }
...
var potentialSecondLevelFriends = secondLevelFriends.filter(n => {
  return isNotAFriend(n);
});
var allPotentialFriends = allUsers.filter(n => {
  return isNotAFriend(n);
});
/******************************************************************************\
	#PROBLEM-08
